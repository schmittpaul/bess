...
#ifndef BESS_UTILS_CRYPTOP_H_
#define BESS_UTILS_CRYPTOP_H_
...
class Crypto {
 ...
 public:
  Crypto();
  Crypto(const char* ciphername, const unsigned char* key,
  ...
  int EncryptUpdate(unsigned char* out, int& outl, const unsigned char* in,
                    int inl);
